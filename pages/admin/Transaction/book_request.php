...
<table>
    ...
    <?php
	 ...
	 WHERE tb_booking_book.approved ='0'
     UNION ALL
    ...
    ?>
        <tr>
            ...
            <td> <a class="btn btn-primary" href="index.php?page=BookBookingForm&id=<?php echo $book_booking_id;?>">Approve</a>
            <form action="../../core/transaction.php" method="post">
                <input type="hidden" name="id" value="<?php echo $book_booking_id;?>">
                <input class="btn btn-primary" type="submit" name="declineBookRequest" Value="Decline">
            </form>
            </td>
        </tr>
    <?php
