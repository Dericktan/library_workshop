            ...
            <div class="container">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="lecturer_no" placeholder="Lecturer No">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary" name="lecturer_register">Register</button>
